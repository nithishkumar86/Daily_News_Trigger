  ...
  return (
    <div className="min-h-screen bg-[#0d0d1a] pb-32">
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="mb-6">
          <h1 className="text-3xl font-bold text-[#f1f5f9]">AI News</h1>
          <p className="text-[#94a3b8] mt-1">All AI updates — models, tools, research</p>
        </div>
        ...
        {loading ? (
          ...
          <div className="text-center py-24 text-[#94a3b8]">
            ...
            <p className="text-lg">No AI news yet today.</p>
